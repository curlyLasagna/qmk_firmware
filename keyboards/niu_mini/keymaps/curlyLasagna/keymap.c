...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[ROOT] = LAYOUT_planck_mit (
			...
			KC_LSFT,    KC_Z,    KC_X, 	  KC_C,    KC_V,    KC_B,          KC_N,     KC_M,      R0,       R1,      R2,      KC_RSFT, 
			KC_LCTL, 	KC_TILD, KC_LGUI, KC_LALT, LOW, 	        SPC,             MO(RAISE), KC_LEFT,  KC_DOWN, KC_UP,   KC_RIGHT
	),

	[LOWER] = LAYOUT_planck_mit (
			KC_GRV, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    				KC_6,    KC_7,     KC_8,    KC_9,    KC_0,    KC_DEL, 
			KC_TRNS, KC_MUTE, KC_VOLD, KC_VOLU, KC_TRNS, KC_TRNS, 				KC_LBRC, KC_RBRC,  KC_BSLS, KC_QUOT, KC_CAPS, KC_INS, 
