...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[ROOT] = LAYOUT_planck_mit (
			...
			OSM(MOD_LSFT), 	KC_Z,   KC_X, 	KC_C,   KC_V,  KC_B,   		KC_N,  KC_M,     KC_COMM,  KC_DOT,  KC_SLSH, LT(ETC, KC_GRV), 
				KC_LCTL, 	KC_ESC, KC_LGUI,  KC_LALT, MO(LOWER), LGUI_T(KC_SPC), LT(RAISE, KC_ENT), KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT
	),
	...
	[LOWER] = LAYOUT_planck_mit (
			...
			KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_BSPC, KC_TRNS, KC_MINS, KC_EQL,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
				KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSPC, KC_HOME, KC_PGDN, KC_PGUP, KC_END
	),
