...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[ROOT] = LAYOUT_ortho_4x12 (
		...
		KC_LCTL, 	KC_LGUI, KC_LALT, LOW,	    GUI,  GUI, 					RSE,  RSE, 	KC_CAPS, KC_RALT, KC_RGUI, 	KC_RCTL
	),

	[LOWER] = LAYOUT_ortho_4x12 (
		KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    		KC_6,     KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL, 
		_______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, 		KC_LBRC,  KC_RBRC, KC_BSLS, _______, KC_LEAD, KC_INS, 
	...
	[RAISE] = LAYOUT_ortho_4x12 (
		...
		KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, 		KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, RESET, 
	...
	[GAME] = LAYOUT_ortho_4x12 (
		...
		KC_LCTL, 	    MO(RAISE),  KC_LALT,  WEP,     KC_SPC, KC_SPC,  KC_ENT,   KC_ENT,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
	),
