...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[ROOT] = LAYOUT_ortho_4x12(
			...
			KC_LCTL, 		KC_LEAD,   KC_LGUI,    KC_LALT, MO(LOWER), LSFT_T(KC_SPC), LGUI_T(KC_ENT),    MO(RAISE), KC_LEFT,  KC_DOWN, KC_UP,   KC_RGHT
	),
	...
	// Mouse emulation
	[ETC] = LAYOUT_ortho_4x12(
			RGB_TOG, KC_BTN4, KC_MS_U, KC_BTN5, RGB_MOD, RGB_HUI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET, 
			KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, RGB_SAI, RGB_VAI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
			KC_TRNS, KC_WH_D, KC_WH_U, KC_WH_R, RGB_SPI, KC_TRNS, KC_TRNS, KC_TRNS, KC_ACL0, KC_ACL1, KC_ACL2, KC_TRNS, 
			KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN1, KC_BTN2, KC_BTN3, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
	),
};
