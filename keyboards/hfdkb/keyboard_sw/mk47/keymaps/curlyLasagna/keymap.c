...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_CAPS, KC_LALT, MO(2),   KC_LGUI, MO(1),       KC_SPC,       KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT),

    [1] = LAYOUT( /* FN */
    KC_GRV,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC, KC_TRNS, KC_MINS, KC_EQL,
